 ...
 *
 * Fixed-position rather than a sidebar column so it drops into either
 * site's course page layout unchanged and behaves the same on mobile,
 * where a client is most likely to actually be using this — checking a
 * lesson off, or reopening a saved one — mid-session with their dog.
 */
